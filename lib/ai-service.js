...
Your questions should make candidates feel like they're having a professional technical discussion with a senior engineer, not answering a quiz.`;
    ...
    try {
      ...
      // Enhanced fallback with STRUCTURED FLOW + TECHNICAL DEPTH
      const fallbackQuestions = [];
      
      // 1. GREETING PHASE
      fallbackQuestions.push({
        id: 0,
        question: `Hello! Thank you for joining us today for this ${jobRole} interview. To start, can you tell me about yourself, walk me through your professional background, and explain what attracted you to the ${jobRole} field?`,
        type: 'behavioral',
        phase: 'greeting',
        category: 'general',
      ...
      if (experience[0]) {
        fallbackQuestions.push({
          id: 1,
          question: `I see from your resume that you worked as ${experience[0].role} at ${experience[0].company}. Can you walk me through your key responsibilities there, the technologies you worked with${experience[0].technologies?.length > 0 ? ` (I noticed you used ${experience[0].technologies[0]})` : ''}, and what were your most significant contributions?`,
        ...
        fallbackQuestions.push({
          id: 1,
          question: `Looking at your background, what experiences have prepared you most for this ${jobRole} position? Walk me through your career journey and highlight the key technical skills you've developed along the way.`,
          type: 'resume-specific',
          phase: 'resume-discussion',
          category: 'general',
      ...
      // 3. PROJECTS DEEP-DIVE PHASE (MOST TECHNICAL)
      if (projects[0]) {
        const proj = projects[0];
        const technologies = proj.technologies?.slice(0, 3).join(', ') || 'technologies';
        
        fallbackQuestions.push({
          id: 2,
          question: `Let's dive deep into your "${proj.projectName}" project. I'd like you to walk me through: 1) What problem it solved and your specific role, 2) The technical architecture and why you chose ${technologies}, 3) The biggest technical challenges you faced - be specific about the problem and your solution approach, 4) How you handled testing, deployment, and scaling concerns.`,
          type: 'project-detail',
          phase: 'projects',
          category: 'projects',
          context: `Deep technical dive into ${proj.projectName}`,
          conversationHistory: []
        });
        ...
        if (projects[1] && numQuestions >= 5) {
          ...
          fallbackQuestions.push({
            id: 3,
            question: `I'm also interested in your "${proj2.projectName}" project. What was the technical stack you used${proj2.technologies?.length > 0 ? ` - I see ${proj2.technologies[0]} was involved` : ''}? Why did you choose those technologies over alternatives? What trade-offs did you consider? If you were to rebuild it today, what would you do differently and why?`,
            type: 'project-detail',
            phase: 'projects',
            category: 'projects',
            context: `${proj2.projectName} technical decisions and architecture`,
            conversationHistory: []
          });
        }
      } else {
        fallbackQuestions.push({
          id: 2,
          question: `Tell me about the most technically challenging project you've worked on as a ${jobRole}. What made it complex? Walk me through your architecture decisions, the technical challenges you encountered, how you approached problem-solving, and what the measurable outcomes were.`,
          type: 'project-detail',
          phase: 'projects',
          category: 'projects',
          context: 'Complex project technical discussion',
          conversationHistory: []
        });
      }
      ...
      if (experience[0]) {
        fallbackQuestions.push({
          ...
          question: `During your time at ${experience[0].company}, tell me about a situation where you faced a significant technical disagreement with a team member or stakeholder. What was the technical issue, how did you approach the discussion, what was your reasoning, and how did it resolve?`,
          type: 'behavioral',
          phase: 'behavioral',
          category: 'experience',
          context: 'Technical conflict resolution and teamwork',
          conversationHistory: []
        });
      } else {
        fallbackQuestions.push({
          id: fallbackQuestions.length,
          question: `Describe a situation where you had to learn a completely new technology or framework under pressure. What was the technology, why did you need it, how did you approach learning it, and how did you successfully apply it to solve the problem?`,
          type: 'behavioral',
          phase: 'behavioral',
          category: 'general',
          context: 'Learning ability and technical adaptability',
          conversationHistory: []
        });
      }
      
      // 5. TECHNICAL DEPTH PHASE
      const primaryTech = skills.technical?.frameworks?.[0] || skills.technical?.languages?.[0] || 'your primary technology';
      const database = skills.technical?.databases?.[0];
      
      fallbackQuestions.push({
        id: fallbackQuestions.length,
        question: `I noticed you have experience with ${primaryTech}. Let's go deeper: How have you used ${primaryTech} in production? What are the key architectural patterns you follow? What are common performance pitfalls and how do you avoid them? Can you explain some advanced features you've leveraged?`,
        type: 'technical',
        phase: 'technical',
        category: 'skills',
        context: `${primaryTech} technical depth and best practices`,
        conversationHistory: []
      });
      ...
      if (numQuestions > fallbackQuestions.length) {
        if (database) {
          fallbackQuestions.push({
            id: fallbackQuestions.length,
            question: `You mentioned working with ${database}. Can you explain your approach to database design? How do you handle data modeling, indexing strategies, query optimization? Walk me through a specific example where you had to optimize database performance.`,
            type: 'technical',
            phase: 'technical',
            category: 'skills',
        ...
        if (projects[0] && projects[0].technologies?.length > 0) {
          fallbackQuestions.push({
            id: fallbackQuestions.length,
            question: `In your "${projects[0].projectName}" project, you used ${projects[0].technologies[0]}. From a ${jobRole} perspective, can you discuss the system design considerations? How did you approach scalability, reliability, and maintainability? What architectural patterns did you implement and why?`,
            type: 'technical',
            phase: 'technical',
            category: 'skills',
            context: 'System design and architecture for specific project',
            conversationHistory: []
          });
        }
        ...
        if (numQuestions > fallbackQuestions.length) {
          fallbackQuestions.push({
            id: fallbackQuestions.length,
            question: `As a ${jobRole}, how do you approach code quality and maintainability? Walk me through your testing strategy, code review practices, and how you ensure your code is production-ready. Give me a specific example from your experience.`,
            type: 'technical',
            phase: 'technical',
            category: 'skills',
            context: 'Code quality and engineering practices',
            conversationHistory: []
          });
        }
      }
